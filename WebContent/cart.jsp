	...
	<body>
		...
		<c:if test="${empty cart.cartItems }">
			<c:if test="${empty user }">
				<div>
					<div style="float: left;padding:30px 0 50px 300px">
						<img alt="" src="${pageContext.request.contextPath }/images/cart-empty.png">
					</div>
					<div style="padding-left: 50px; float: left;padding-top: 90px">
						<p style="font-size: 30px; color: gray; font-weight: bolder;margin-top:20px;margin-bottom: 20px;">您的购物车还是空的！</p>
						<a href="${pageContext.request.contextPath }/login.jsp" style="color: white;background-color:orange; border: thin solid orange;padding:10px 20px 10px 20px;margin-right: 10px">立即登录</a>
						<a href="${pageContext.request.contextPath }" style="color: orange; border: thin solid orange;padding:10px 20px 10px 20px">马上去购物</a>
					</div>
				</div>
			</c:if>
			<c:if test="${!empty user }">
				<div>
					...
					<div style="padding-left: 50px; float: left;padding-top: 90px">
						<p style="font-size: 30px; color: gray; font-weight: bolder;margin-bottom: 20px;">您的购物车还是空的！</p>
						<a href="${pageContext.request.contextPath }" style="color: orange; border: thin solid orange;padding:10px 20px 10px 20px">马上去购物</a>
					</div>
				</div>
			</c:if>
