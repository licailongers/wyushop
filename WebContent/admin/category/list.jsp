...
<script type="text/javascript">
	...
	function delCategory(cid) {
		...
		if (isDel) {
			//要删除
			location.href = "${pageContext.request.contextPath}/admin?method=delCategoryByCid&cid="+cid;
		}
	}
						...
						<c:forEach items="${categoryList }" var="category">
							<tr onmouseover="this.style.backgroundColor = 'white'"
								...
								<td align="center" style="HEIGHT: 22px">
									<a href="${ pageContext.request.contextPath }/admin?method=editCategoryUI&cid=${category.cid }">
								...
								<td align="center" style="HEIGHT: 22px"><a
									href="javascript:;" onclick="delCategory('${category.cid }')">
