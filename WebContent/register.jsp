	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form id="myform" class="form-horizontal" style="margin-top: 5px;" method="post"
					...
					<div class="form-group opt">
						...
						<div class="col-sm-6">
							...
							<label class="error" for="sex" style="display: none;margin-left: 5px">您没有选择性别！</label>
						</div>
					</div>
					<div class="form-group">
					...
					<div style="margin-left: 130px;margin-bottom: 10px;color: red;font-weight: 900">
